...
public class CommandInfo {
    ...
    CommandInfo(String name, String category, JSONArray arguments, String usage, String description, Permission[] userPermissions, Permission[] clientPermissions, boolean ownerOnly, boolean enabled, String... aliases) {
        this.name = name;

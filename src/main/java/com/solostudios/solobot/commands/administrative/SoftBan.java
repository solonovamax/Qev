...
public class SoftBan extends AbstractCommand {
    public SoftBan() {
        super("tempban");
        this.withAliases("softban", "temporaryban");
        this.withCategory("Moderation");
        this.withDescription("Temporarily bans a user.");
        this.withEnabled(false);
        this.withClientPermissions(Permission.KICK_MEMBERS);
        this.withUserPermissions(Permission.KICK_MEMBERS, Permission.BAN_MEMBERS);
        /*
        super("tempban",
                "Moderation",

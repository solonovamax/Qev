...
public class EightBall extends AbstractCommand {
	...
	@NotNull
	private final String[] answerList = new String[]{
			"Maybe.",
			"Who knows?",
			"Yes!",
			"No.",
	...
	public EightBall() {
		super("8ball");
		this.setAliases("eightball");
		this.setCategory("Fun");
		this.setDescription("Ask the magic 8 ball a question! It will give you the answer.");
		this.setArguments(new JSONArray()
								  .put(new JSONObject()
											   .put("key", "question")
											   .put("type", String.class)
											   .put("error", "Invalid question!")));
		this.setUsage("8ball {question}");
	}

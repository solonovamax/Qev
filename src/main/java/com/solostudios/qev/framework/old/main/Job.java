...
public class Job<T> implements Comparable<Job<T>> {
	...
	private final MongoCollection<org.bson.Document> userData;
	private final Long                               guildID;
	private final Long                               userID;
	private final T                                  payload;
	private final Priority                           priority;
	
	public Job(T payload, Priority priority, MongoCollection<org.bson.Document> userData, Long guildID, Long userID,
			   Exchanger exchanger) {

...
import com.solostudios.qev.framework.command.handler.abstracts.AbstractCategory;
...
public class CommandHandler {
    ...
    private static void addCommand(@NotNull AbstractCommand command, String name, @NotNull String... aliases)
